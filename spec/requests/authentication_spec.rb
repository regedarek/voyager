...
describe "Authentication" do
  ...
  describe "Sign in" do
    context "successful" do
      it { sign_in({"Email" => "user@example.com", "Password" => "secret"},root_path, "Logged in!") }
      
      it "and rememeber user" do
        sign_in({"Email" => "user@example.com", "Password" => "secret"},root_path, "Logged in!", true)
      end
    end
    ...
    it "fail" do
      ...
      sign_in({"Email" => "user@example.com", "Password" => "bad"}, sessions_path, 
		"Email or password was invalid")
    end
  end
  ...
  describe "Forgot password" do
    it "send email with link to change password" do
      send_forgot_password_email("user@example.com")   
    end
    
    it "change password" do
      change_password("user@example.com") 
    end
  end
